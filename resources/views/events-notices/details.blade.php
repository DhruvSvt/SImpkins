...
@section('content')
        ...
        <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">
                            {{ __('list') . ' ' . __('event-notice') }}
                        </h4>
                        <div class="row">
                            <div class="col-12">
                                <table aria-describedby="mydesc" class='table table-responsive' id='table_list'
                                    data-toggle="table" data-url="{{ url('event-notice-list') }}" data-click-to-select="true"
                                    ...
                                    data-export-options='{ "fileName": "event-notice-list-<?= date('d-m-y') ?>"
                                    ,"ignoreColumn":
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" data-field="order" data-sortable="false">
                                                {{ __('order') }}</th>
                                            <th scope="col" data-field="is_new_text" data-sortable="false">
                                                {{ __('new') }}</th>
                                            <th scope="col" data-field="type" data-sortable="false">
                                                {{ __('type') }}</th>
                                            {{-- @canany(['event-notice-edit', 'event-notice-delete']) --}}
    ...
    {{-- @can('event-notice-edit') --}}
    <div class="modal fade" id="editModal" data-backdrop="static" tabindex="-1" role="dialog"
        aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="exampleModalLabel">{{ __('edit') . ' ' . __('event-notice') }}</h4><br>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true"><i class="fa fa-close"></i></span>
                    </button>
                </div>
                <form id="edit-form" class="edit-student-registration-form" novalidate="novalidate"
                    action="{{ url('event-notice') }}" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-12 col-md-4">
                                ...
                                {{-- <div style="width: 100px;">
                                    <img src="" id="edit-link-image-tag" class="img-fluid w-100" />
                                </div> --}}
                            </div>
                            <div class="form-group col-sm-12 col-md-4">
