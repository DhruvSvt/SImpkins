                        ...
                        <form class="pt-3 student-registration-form" enctype="multipart/form-data"
                            ...
                            <div class="row">
                                <div class="form-group col-sm-12 col-md-4">
                                    <label>{{ __('candidate') . ' ' . __('name') }} <span class="text-danger">*</span></label>
                                    {!! Form::text('candidate_name', null, ['placeholder' => __('candidate') . ' ' . __('name'), 'class' => 'form-control']) !!}
                                </div>
                                <div class="form-group col-sm-12 col-md-4">
                                ...
                                <div class="form-group col-sm-12 col-md-4">
                                    ...
                                    {!! Form::text('highest_qualification', null, ['placeholder' => __('highest_qualification'), 'class' => 'form-control']) !!}
                                </div>
                                <div class="form-group col-sm-12 col-md-4">
