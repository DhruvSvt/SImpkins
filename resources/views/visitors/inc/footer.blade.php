{{-- <footer class="footer-bg footer-p pt-90" style="background-color: #07294d;">
...
max-width: 100%;"></a>
                        ...
                        <div class="f-contact">
                            <p>Simpkins School is located in the heart of the historical city of Agra. The school
                                was founded three decades back with a commitment to excellence and for providing
                                opportunities..</p>
                        </div>
                ...
                <div class="col-xl-2 col-lg-2 col-6">
                    <div class="footer-widget">
                        ...
                        <div class="footer-link">
                            <ul>
                                <li><a href="admission-registration.php"> Admission Registration </a></li>
                    ...
                    <div class="footer-widget">
                        ...
                        <div class="footer-link">
                            <ul>
                                ...
                                <li><a href="enhancement-enrichment-classes.php"> Enhancement & Enrichment Classes
                                    </a></li>
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-12 text-center">
                    Copyright &copy; Simpkins School Agra 2023 . All rights reserved.
                </div>
            </div>
        </div>
    </div>
...
<footer class="page__footer" id="asu-footer" role="contentinfo">
    <div class="block block--asu-edu-asufooter">
        ...
        <div class="wrapper d-none d-sm-block" id="wrapper-footer-innovation">
