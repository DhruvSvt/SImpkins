                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" data-field="menu_name" data-sortable="false">
                                                {{ __('menu') .' '. _('name') }}</th>
                                            <th scope="col" data-field="banner_image" data-formatter="bannerImageFormatter" data-sortable="false">
                                                {{ __('banner_image') }}</th>
                                            <th scope="col" data-field="content_image" data-formatter="contentImageFormatter" data-sortable="false">
                                                    {{ __('content_image') }}</th>
                    ...
                    <form id="edit-form" class="edit-student-registration-form" novalidate="novalidate"
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-12 col-md-4">
                                    ...
                                    <div class="input-group col-xs-12">
                                        <input type="text" class="form-control file-upload-info" disabled=""
                                            placeholder="{{ __('banner_image') }}" required="required" id="edit_banner_image" />
                                ...
                                <div class="form-group col-sm-12 col-md-4">
                                    <label>{{ __('content-image') }} <span class="text-danger">*</span></label>
                                    <input type="file" name="content_image" class="file-upload-default" />
                                    <div class="input-group col-xs-12">
                                        <input type="text" class="form-control file-upload-info" disabled=""
                                            placeholder="{{ __('content-image') }}" required="required" id="edit_content_image" />
                                        <span class="input-group-append">
                                            <button class="file-upload-browse btn btn-theme"
                                                type="button">{{ __('upload') }}</button>
                                        </span>
