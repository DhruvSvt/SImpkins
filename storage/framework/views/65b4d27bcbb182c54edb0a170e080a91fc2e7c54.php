                        ...
                        <form class="create-form pt-3" id="formdata" action="<?php echo e(url('teachers')); ?>"
                            ...
                            <div class="row">
                                <div class="form-group col-sm-12 col-md-6">
                                    ...
                                    <?php echo Form::text('mobile', null, ['required', 'placeholder' => __('mobile'), 'class' => 'form-control']); ?>
                            ...
                            <div class="row">
                                <div class="form-group col-sm-12 col-md-6">
                                    ...
                                    <?php echo Form::text('dob', null, ['required', 'readonly', 'placeholder' => __('dob'), 'class' => 'datepicker-popup form-control']); ?>
    ...
    <div class="modal fade" id="editModal" data-backdrop="static" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form id="formdata" class="editform" action="<?php echo e(url('teachers')); ?>" novalidate="novalidate"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row form-group">
                            <div class="form-group col-sm-12 col-md-6">
                                <label><?php echo e(__('dob')); ?> <span class="text-danger">*</span></label>
                                <?php echo Form::text('dob', null, ['required', 'readonly', 'placeholder' => __('dob'), 'class' => 'datepicker-popup form-control', 'id' => 'dob']); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/mdcollegeagra/simpkins.mdayurvediccollege.in/resources/views/teacher/index.blade.php ENDPATH**/ ?>