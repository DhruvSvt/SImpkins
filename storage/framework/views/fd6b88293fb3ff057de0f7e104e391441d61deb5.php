...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav">
        ...
        <li class="nav-item">
            <a href="<?php echo e(url('/')); ?>" class="nav-link"><i class="fa fa-home menu-icon"></i> <span class="menu-title"><?php echo e(__('dashboard')); ?></span></a>
        </li>
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['medium-create','section-create','subject-create','class-create','subject-create','class-teacher-create','subject-teacher-list','subject-teachers-create','assign-class-to-new-student','promote-student-create'])): ?>
            <li class="nav-item">
                <a class="nav-link" data-toggle="collapse" href="#academics-menu" aria-expanded="false" aria-controls="academics-menu"><i class="fa fa-university menu-icon"></i> <span class="menu-title"><?php echo e(__('academics')); ?></span>  </a>
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['student-create','student-list','category-create','student-reset-password','class-teacher'])): ?>
            <li class="nav-item">
                <a class="nav-link" data-toggle="collapse" href="#student-menu" aria-expanded="false" aria-controls="academics-menu"><i class="fa fa-graduation-cap menu-icon"></i> <span class="menu-title"><?php echo e(__('students')); ?></span>
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('teacher-create')): ?>
            <li class="nav-item">
                <a href="<?php echo e(route('teachers.index')); ?>" class="nav-link"><i class="fa fa-user menu-icon"></i> <span class="menu-title"><?php echo e(__('teacher')); ?></span>  </a>
            </li>
        <?php endif; ?>
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('parents-create')): ?>
            <li class="nav-item">
                <a href="<?php echo e(route('parents.index')); ?>" class="nav-link"><i class="fa fa-users menu-icon"></i> <span class="menu-title"><?php echo e(__('parents')); ?></span>  </a>
            </li>
        <?php endif; ?>
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['timetable-create','class-timetable','teacher-timetable'])): ?>
            <li class="nav-item">
                <a class="nav-link" data-toggle="collapse" href="#timetable-menu" aria-expanded="false" aria-controls="timetable-menu"> <i class="fa fa-calendar menu-icon"></i> <span class="menu-title"><?php echo e(__('timetable')); ?></span>
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['holiday-create','holiday-list'])): ?>
            <li class="nav-item">
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('holiday-list')): ?>
                    <a href="<?php echo e(route('holiday.index')); ?>" class="nav-link"> <i class="fa fa-calendar-check-o menu-icon"></i> <span class="menu-title"><?php echo e(__('holiday_list')); ?></span>  </a>
                <?php endif; ?>
            </li>
        <?php endif; ?>
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['lesson-list','lesson-create','lesson-edit','lesson-delete','topic-list','topic-create','topic-edit','topic-delete'])): ?>
            <li class="nav-item">
                <a class="nav-link" data-toggle="collapse" href="#subject-lesson-menu" aria-expanded="false" aria-controls="subject-lesson-menu"><i class="fa fa-book menu-icon"></i> <span class="menu-title"><?php echo e(__('subject_lesson')); ?></span>  </a>
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['assignment-create','assignment-submission'])): ?>
            <li class="nav-item">
                <a class="nav-link" data-toggle="collapse" href="#student-assignment-menu" aria-expanded="false" aria-controls="student-assignment-menu"><i class="fa fa-tasks menu-icon"></i> <span class="menu-title"><?php echo e(__('student_assignment')); ?></span>  </a>
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('slider-create')): ?>
            <li class="nav-item">
                <a href="<?php echo e(route('sliders.index')); ?>" class="nav-link"><i class="fa fa-list menu-icon"></i> <span class="menu-title"><?php echo e(__('sliders')); ?></span>  </a>
            </li>
        <?php endif; ?>
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['class-teacher'])): ?>
            <li class="nav-item">
                <a class="nav-link" data-toggle="collapse" href="#attendance-menu" aria-expanded="false" aria-controls="attendance-menu"><i class="fa fa-check menu-icon"></i> <span class="menu-title"><?php echo e(__('attendance')); ?></span>  </a>
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('announcement-create')): ?>
            <li class="nav-item">
                <a class="nav-link" href="<?php echo e(route('announcement.index')); ?>"><i class="fa fa-check menu-icon"></i>  <span class="menu-title"><?php echo e(__('announcement')); ?></span>
                     </a>
            </li>
        <?php endif; ?>
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['exam-create','exam-timetable-create','exam-upload-marks','grade-create'])): ?>
            <li class="nav-item">
                <a class="nav-link" data-toggle="collapse" href="#exam-menu" aria-expanded="false" aria-controls="exam-menu">
                  <i class="fa fa-book menu-icon"></i>  <span class="menu-title"><?php echo e(__('exam')); ?></span>
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('session-year-create')): ?>
            <li class="nav-item">
                <a href="<?php echo e(route('session-years.index')); ?>" class="nav-link"> <i class="fa fa-calendar-o menu-icon"></i> <span class="menu-title"><?php echo e(__('session_years')); ?></span>  </a>
            </li>
        <?php endif; ?>
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['setting-create','fcm-setting-create','email-setting-create','privacy-policy','contact-us','about-us','role-create'])): ?>
            <li class="nav-item">
                <a class="nav-link" data-toggle="collapse" href="#settings-menu" aria-expanded="false" aria-controls="settings-menu"><i class="fa fa-cog menu-icon"></i> <span class="menu-title"><?php echo e(__('system_settings')); ?></span>  </a>
...
<?php /**PATH /home1/mdcollegeagra/simpkins.mdayurvediccollege.in/resources/views/layouts/sidebar.blade.php ENDPATH**/ ?>