            ...
            <li class="nav-item nav-profile dropdown">
                <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-toggle="dropdown" aria-expanded="true">
                    ...
                    <div class="nav-profile-text">
                        <p class="mb-1 "><?php echo e(Auth::user()->first_name); ?></p>
                    </div>
                </a>
...
<?php /**PATH /home1/mdcollegeagra/simpkins.mdayurvediccollege.in/resources/views/layouts/header.blade.php ENDPATH**/ ?>