                    ...
                    <form action="<?php echo e(url('session-years')); ?>" class="create-form pt-3" id="formdata" method="POST" novalidate="novalidate">
                        ...
                        <div class="row">
                            <div class="form-group col-sm-12 col-md-6">
                                ...
                                <?php echo Form::text('start_date', null, ['required','readonly', 'placeholder' => __('start_date'), 'class' => 'datepicker-popup form-control']); ?>
                            ...
                            <div class="form-group col-sm-12 col-md-6">
                                ...
                                <?php echo Form::text('end_date', null, ['required','readonly', 'placeholder' => __('end_date'), 'class' => 'datepicker-popup form-control']); ?>
            ...
            <form id="formdata" class="editform" action="<?php echo e(url('session-years')); ?>" novalidate="novalidate">
                ...
                <div class="modal-body">
                    ...
                    <div class="row form-group">
                        <div class="form-group col-sm-12 col-md-12">
                            <label><?php echo e(__('start_date')); ?> <span class="text-danger">*</span></label>
                            <?php echo Form::text('start_date', null, ['required','readonly', 'placeholder' => __('start_date'), 'class' => 'datepicker-popup form-control','id'=>'start_date']); ?>
                    ...
                    <div class="row form-group">
                        <div class="form-group col-sm-12 col-md-12">
                            <label><?php echo e(__('end_date')); ?> <span class="text-danger">*</span></label>
                            <?php echo Form::text('end_date', null, ['required','readonly', 'placeholder' => __('end_date'), 'class' => 'datepicker-popup form-control','id'=>'end_date']); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/mdcollegeagra/simpkins.mdayurvediccollege.in/resources/views/session_years/index.blade.php ENDPATH**/ ?>