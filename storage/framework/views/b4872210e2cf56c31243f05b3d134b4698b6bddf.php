    ...
    <script>
        window.actionEvents = {
            'click .reset_password': function(e, value, row, index) {
                Swal.fire({
                    title: "<?php echo e(__('change_password_title')); ?>",
                    text: "<?php echo e(__('confirm_change_message')); ?>",
                    icon: 'warning',
                    showCancelButton: true,
                    confirmButtonColor: '#3085d6',
                    cancelButtonColor: '#d33',
                    confirmButtonText: "<?php echo e(__('yes_change')); ?>"
                }).then((result) => {
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/mdcollegeagra/simpkins.mdayurvediccollege.in/resources/views/students/reset_password.blade.php ENDPATH**/ ?>