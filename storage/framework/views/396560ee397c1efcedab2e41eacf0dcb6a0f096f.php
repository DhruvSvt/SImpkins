                ...
                <div class="col-md-4 stretch-card grid-margin">
                    <div class="card   card-img-holder">
                        <div class="card-body">
                            ...
                            <h2 class="mb-1"><?php echo e($teacher); ?></h2>
                ...
                <div class="col-md-4 stretch-card grid-margin">
                    <div class="card  card-img-holder ">
                        <div class="card-body">
                            ...
                            <h2 class="mb-1"><?php echo e($student); ?></h2>
                        </div>
                    </div>
                </div>
            <?php endif; ?>
                ...
                <div class="col-md-4 stretch-card grid-margin">
                    <div class="card  card-img-holder ">
                        <div class="card-body">
                            ...
                            <h2 class="mb-1"><?php echo e($parent); ?></h2>
                        </div>
                    </div>
                </div>
            <?php endif; ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/mdcollegeagra/simpkins.mdayurvediccollege.in/resources/views/home.blade.php ENDPATH**/ ?>