                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-12 col-md-4">
                                    ...
                                    <?php echo Form::tel('mobile', null, ['placeholder' => __('mobile'), 'class' => 'form-control', 'id' => 'edit_mobile']); ?>
                                ...
                                <div class="form-group col-sm-12 col-md-4">
                                    ...
                                    <?php echo Form::text('dob', null, ['readonly', 'placeholder' => __('dob'), 'class' => 'datepicker-popup form-control', 'id' => 'edit_dob']); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-12 col-md-4">
                                    ...
                                    <?php echo Form::text('admission_no', null, ['placeholder' => __('admission_no'), 'class' => 'form-control', 'id' => 'edit_admission_no']); ?>
                                ...
                                <div class="form-group col-sm-12 col-md-4">
                                    ...
                                    <?php echo Form::text('admission_date', null, ['readonly', 'placeholder' => __('admission_date'), 'class' => 'datepicker-popup form-control', 'id' => 'edit_admission_date']); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-12 col-md-4">
                                    <label><?php echo e(__('father') . ' ' . __('mobile')); ?> <span
                                            class="text-danger">*</span></label>
                                    <?php echo Form::text('father_mobile', null, ['placeholder' => __('father') . ' ' . __('mobile'), 'class' => 'form-control', 'id' => 'edit_father_mobile', 'readonly' => true]); ?>

                                </div>
                                <div class="form-group col-sm-12 col-md-4">
                                    <label><?php echo e(__('father') . ' ' . __('dob')); ?> <span class="text-danger">*</span></label>
                                    <?php echo Form::text('father_dob', null, ['placeholder' => __('father') . ' ' . __('dob'), 'class' => 'form-control datepicker-popup form-control', 'id' => 'edit_father_dob', 'readonly' => true]); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-12 col-md-4">
                                    <label><?php echo e(__('mother') . ' ' . __('mobile')); ?> <span
                                            class="text-danger">*</span></label>
                                    <?php echo Form::text('mother_mobile', null, ['placeholder' => __('mother') . ' ' . __('mobile'), 'class' => 'form-control', 'id' => 'edit_mother_mobile', 'readonly' => true]); ?>

                                </div>
                                <div class="form-group col-sm-12 col-md-4">
                                    <label><?php echo e(__('mother') . ' ' . __('dob')); ?> <span class="text-danger">*</span></label>
                                    <?php echo Form::text('mother_dob', null, ['placeholder' => __('mother') . ' ' . __('dob'), 'class' => 'form-control datepicker-popup form-control', 'id' => 'edit_mother_dob', 'readonly' => true]); ?>
                            ...
                            <div class="row" id="edit_guardian_div" style="display:none;">
                                ...
                                <div class="form-group col-sm-12 col-md-4">
                                    <label><?php echo e(__('guardian') . ' ' . __('mobile')); ?> <span
                                            class="text-danger">*</span></label>
                                    <?php echo Form::text('guardian_mobile', null, ['placeholder' => __('guardian') . ' ' . __('mobile'), 'class' => 'form-control', 'id' => 'edit_guardian_mobile', 'readonly' => true]); ?>

                                </div>
                                <div class="form-group col-sm-12 col-md-4">
                                    <label><?php echo e(__('guardian') . ' ' . __('dob')); ?> <span class="text-danger">*</span></label>
                                    <?php echo Form::text('guardian_dob', null, ['placeholder' => __('guardian') . ' ' . __('dob'), 'class' => 'form-control datepicker-popup form-control', 'id' => 'edit_guardian_dob', 'readonly' => true]); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/mdcollegeagra/simpkins.mdayurvediccollege.in/resources/views/students/details.blade.php ENDPATH**/ ?>