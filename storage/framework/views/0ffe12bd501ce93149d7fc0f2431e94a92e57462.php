                        ...
                        <form class="create-form pt-3" id="formdata" action="<?php echo e(url('holiday')); ?>" method="POST" novalidate="novalidate">
                            ...
                            <div class="row">
                                <div class="form-group col-sm-12 col-md-6">
                                    ...
                                    <?php echo Form::text('date', null, ['required', 'readonly', 'placeholder' => __('date'), 'class' => 'datepicker-popup form-control']); ?>
                                    ...
                                    <table aria-describedby="mydesc" class='table' id='table_list' data-toggle="table"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col" data-field="date" data-sortable="false"><?php echo e(__('date')); ?>
    ...
    <div class="modal fade" id="editModal" data-backdrop="static" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form id="formdata" class="editform" action="<?php echo e(url('holiday')); ?>" novalidate="novalidate">
                    <?php echo csrf_field(); ?>
                    <div class="modal-body">
                        ...
                        <div class="row form-group">
                            <div class="col-sm-12 col-md-12">
                                <label><?php echo e(__('date')); ?> <span class="text-danger">*</span></label>
                                <?php echo Form::text('date', null, ['required', 'readonly', 'placeholder' => __('date'), 'class' => 'datepicker-popup form-control', 'id' => 'date']); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/mdcollegeagra/simpkins.mdayurvediccollege.in/resources/views/holiday/index.blade.php ENDPATH**/ ?>