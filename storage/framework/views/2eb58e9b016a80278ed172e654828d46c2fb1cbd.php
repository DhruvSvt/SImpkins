                        ...
                        <form class="pt-3 student-registration-form" enctype="multipart/form-data" action="<?php echo e(route('students.store')); ?>" method="POST" novalidate="novalidate">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-12 col-md-4">
                                    ...
                                    <?php echo Form::text('mobile', null, ['placeholder' => __('mobile'), 'class' => 'form-control']); ?>
                                ...
                                <div class="form-group col-sm-12 col-md-4">
                                    ...
                                    <?php echo Form::text('dob', null, ['placeholder' => __('dob'), 'class' => 'datepicker-popup form-control']); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-12 col-md-4">
                                    ...
                                    <?php echo Form::text('admission_no', $admission_no, ['readonly','placeholder' => __('admission_no'), 'class' => 'form-control']); ?>


                                </div>
                                <div class="form-group col-sm-12 col-md-4">
                                    <label><?php echo e(__('roll_no')); ?> <span class="text-danger">*</span></label>
                                    <?php echo Form::text('roll_number', null, ['placeholder' => __('roll_no'), 'class' => 'form-control']); ?>
                                ...
                                <div class="form-group col-sm-12 col-md-4">
                                    ...
                                    <?php echo Form::text('admission_date', null, ['readonly', 'placeholder' => __('admission_date'), 'class' => 'datepicker-popup form-control']); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-12 col-md-4">
                                    ...
                                    <?php echo Form::text('father_mobile', null, ['placeholder' => __('father') . ' ' . __('mobile'), 'class' => 'form-control', 'id' => 'father_mobile']); ?>

                                </div>
                                <div class="form-group col-sm-12 col-md-4">
                                    <label><?php echo e(__('father') . ' ' . __('dob')); ?> <span class="text-danger">*</span></label>
                                    <?php echo Form::text('father_dob', null, ['placeholder' => __('father') . ' ' . __('dob'), 'class' => 'form-control datepicker-popup form-control', 'id' => 'father_dob']); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-12 col-md-4">
                                    ...
                                    <?php echo Form::text('mother_mobile', null, ['placeholder' => __('mother') . ' ' . __('mobile'), 'class' => 'form-control', 'id' => 'mother_mobile']); ?>

                                </div>
                                <div class="form-group col-sm-12 col-md-4">
                                    <label><?php echo e(__('mother') . ' ' . __('dob')); ?> <span class="text-danger">*</span></label>
                                    <?php echo Form::text('mother_dob', null, ['placeholder' => __('mother') . ' ' . __('dob'), 'class' => 'form-control datepicker-popup form-control', 'id' => 'mother_dob']); ?>
                            ...
                            <div class="row" id="guardian_div" style="display:none;">
                                ...
                                <div class="form-group col-sm-12 col-md-4">
                                    ...
                                    <?php echo Form::text('guardian_mobile', null, ['placeholder' => __('guardian') . ' ' . __('mobile'), 'class' => 'form-control', 'id' => 'guardian_mobile']); ?>
                                ...
                                <div class="form-group col-sm-12 col-md-12">
                                    ...
                                    <div class="d-flex">
                                        <div class="form-check form-check-inline">
                                            <label class="form-check-label">
                                                <?php echo Form::radio('guardian_gender', 'male'); ?>
                                        ...
                                        <div class="form-check form-check-inline">
                                            <label class="form-check-label">
                                                <?php echo Form::radio('guardian_gender', 'female'); ?>
                                ...
                                <div class="form-group col-sm-12 col-md-4">
                                    ...
                                    <?php echo Form::text('guardian_dob', null, ['placeholder' => __('guardian') . ' ' . __('dob'), 'class' => 'form-control datepicker-popup form-control', 'id' => 'guardian_dob']); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/mdcollegeagra/simpkins.mdayurvediccollege.in/resources/views/students/index.blade.php ENDPATH**/ ?>